        ...
        <div class="max-w-3xl w-full p-12 mx-auto">
            ...
            <div class="flex flex-col gap-y-3">
                ...
                <!-- <div class="flex gap-x-5">
                    ...
                    <img src="https://sammidev.codes/sammi.png" alt="empty cart" class="w-12 h-14 rounded-xl object-cover">
                    <div>
                        <h1 class="font-medium text-black">Bunga Anggrek</h1>
                        <h1 class="font-semibold text-orange-500 text-xs">Rp 500.000,00</h1>
                    </div>
                    <div class="flex ml-5 justify-between w-24 items-center">
                        <button id="btn-minus" class="bg-gray-300 text-gray-800 hover:bg-gray-400 rounded-l-lg px-2 py-1">
                            -
                        </button>
                        <input id="quantity" type="text" class="w-12 text-center border-gray-300 focus:outline-none focus:border-blue-300 px-2 py-1" value="0">
                        <button id="btn-plus" class="bg-gray-300 text-gray-800 hover:bg-gray-400 rounded-r-lg px-2 py-1">
                            +
                        </button>
                    </div>
                </div> -->
